...
namespace TicTacToegame {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ вклВыклЗвукToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->вклВыклЗвукToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->менюToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->новаяИграToolStripMenuItem,
					this->вернутьсяToolStripMenuItem, this->вклВыклЗвукToolStripMenuItem
			});
			...
			this->новаяИграToolStripMenuItem->Size = System::Drawing::Size(154, 22);
			...
			this->вернутьсяToolStripMenuItem->Size = System::Drawing::Size(154, 22);
			...
			// 
			// вклВыклЗвукToolStripMenuItem
			// 
			this->вклВыклЗвукToolStripMenuItem->Name = L"вклВыклЗвукToolStripMenuItem";
			this->вклВыклЗвукToolStripMenuItem->Size = System::Drawing::Size(154, 22);
			this->вклВыклЗвукToolStripMenuItem->Text = L"Вкл/Выкл звук";
			this->вклВыклЗвукToolStripMenuItem->Click += gcnew System::EventHandler(this, &GameForm::вклВыклЗвукToolStripMenuItem_Click);
			// 
			...
			this->оПрограммеToolStripMenuItem->Click += gcnew System::EventHandler(this, &GameForm::оПрограммеToolStripMenuItem_Click);
			// 
			...
			this->dataGridView->BackgroundColor = System::Drawing::Color::DarkViolet;
			this->dataGridView->ColumnHeadersHeightSizeMode = System::Windows::Forms::DataGridViewColumnHeadersHeightSizeMode::AutoSize;
			this->dataGridView->Dock = System::Windows::Forms::DockStyle::Fill;
			this->dataGridView->Location = System::Drawing::Point(0, 24);
			this->dataGridView->Name = L"dataGridView";
			this->dataGridView->Size = System::Drawing::Size(784, 515);
...
#pragma endregion
	...
	private: System::Void вклВыклЗвукToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e);
